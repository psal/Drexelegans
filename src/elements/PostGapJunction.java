...
/**
 * A postsynaptic gap junction. Attached to a Dendrite. Recieves fire from PreSynapse.
 * @author Andrew W.E. McDonald
 *
 */
public class PostGapJunction extends GapJunction{
		 ...
		 */
		public PostGapJunction(int post_synapse_num, double timeout, double strength_multiplier){
			super();
		...
		public PostGapJunction(Location l, int post_synapse_num, double timeout, double strength_multiplier){
			super();
			location = l;
			this.timeout = timeout;
			this.strength_multiplier = strength_multiplier;
